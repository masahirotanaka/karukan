...
- `CandidateWindowController.swift` — custom NSPanel candidate window (engine pre-paginates; renders the page as a vertical list or, when `ShowCandidates` carries `grid_columns`, an NSGridView grid)
